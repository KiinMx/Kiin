...
| RF-019 | El filtro de **Materia** debe filtrar todos los cursos relacionados a la materia seleccionada | Alta |
...
### Matriz de Dependencias Cross-Module

Indica cuántas dependencias directas existen **desde** el módulo de la fila **hacia** el módulo de la columna. Las celdas con valor alto representan acoplamiento significativo.

|  | M1 | M2 | M3 | M4 | M5 | M6 | M7 | M8 | M9 | M10 | RNF |
| :---- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **M1** | 12 | — | — | — | — | — | — | — | — | — | — |
| **M2** | 3 | 9 | — | — | — | — | — | — | — | — | — |
| **M3** | 3 | 1 | 8 | — | — | — | — | — | — | — | — |
...
**Lectura:** La fila M7 (Exportación) tiene 2 dependencias hacia M5 (Calendario) y 1 hacia RNF, lo que significa que cambios en la visualización del calendario o en la autenticación impactan directamente la exportación.

---

### Cadenas Críticas de Dependencia

Las siguientes cadenas representan los caminos de dependencia más largos del sistema. Un cambio en cualquier nodo de la cadena puede propagar impacto hasta el final.

**Cadena 1 — Datos → Filtrado → Generación → Visualización → Exportación** (camino más largo)

RF-001 → RF-003 → RF-007 → RF-008 → RF-017 → RF-028 → RF-029 → RF-033 → RF-045 → RF-054 → RF-055

                                                                         ↘ RF-059 → RF-060

                                                                         ↘ RF-062 → RF-063

**Cadena 2 — Datos → Filtrado → Generación → Fijación → Interfaz**

RF-001 → RF-003 → RF-007 → RF-008 → RF-017 → RF-028 → RF-029 → RF-033 → RF-040 → RF-068 → RF-064

                                                                         ↘ RF-042 → RF-068

**Cadena 3 — Datos → Filtrado Dinámico**

RF-001 → RF-003 → RF-007 → RF-008 → RF-017 → RF-023 → RF-025

                                    ↘ RF-019 → RF-024 → RF-025

**Cadena 4 — Versionamiento**

RF-001 → RF-002 → RF-012 → RF-073
